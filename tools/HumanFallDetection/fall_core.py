...
class FallDetectorMulti:
    ...
    def load_model(self, path):
        ...
        if 'models.common' in sys.modules:
            del sys.modules['models.common']
        if 'models.yolo' in sys.modules:
            del sys.modules['models.yolo']
        if 'models.experimental' in sys.modules:
            del sys.modules['models.experimental']
